...
while($rp = mysqli_fetch_array($sqlp)){
	...
	echo "<br>"; 
	echo "<img src='../fotoproduk/$rp[foto]' border='1' width='100px'>
		  <hr>
		  <big>$nm...</big>
		  <hr>
	...
	echo "<br><a href='?p=produkdetail&id=$rp[idproduk]'><button type='button' class='btn btn-add'>Detail</button></a>
		  <a href='?p=produkedit&id=$rp[idproduk]'><button type='button' class='btn btn-add'>Edit Produk</button></a>
