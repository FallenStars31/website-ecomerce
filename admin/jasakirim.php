...
while($rj = mysqli_fetch_array($sqlj)){
	...
	echo "<br><a href='?p=jasakirimedit&idj=$rj[idjasa]'><button type='button' class='btn btn-add'>Ubah Jasa Kirim</button></a> ";
	echo "<br><a href='?p=jasakirimdel&idj=$rj[idjasa]'><button type='button' class='btn btn-add'>Hapus Jasa Kirim</button></a> ";
	echo "</div>";
	echo "</div><br>";
	echo "</div>";
}
